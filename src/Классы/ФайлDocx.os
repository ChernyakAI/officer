...
&Прозвище("docx")
&Желудь
Процедура ПриСозданииОбъекта(&Пластилин МенеджерФайлов, &Пластилин СериализацияДанныхXML)
...
Функция ПодставитьПараметрыВШаблон(ДанныеXML)
	...
	Для Каждого НастройкаПодстановки Из _МенеджерФайлов.НастройкиПодстановки() Цикл
