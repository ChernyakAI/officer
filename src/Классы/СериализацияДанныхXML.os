...
//
// Изменения:
//   - адаптация под сухой односемянный синкарпный нижний плод с жестким кожистым околоплодником,
//       частично или полностью заключённый в плюске
//   - чтение полных имен узлов, а не локальных
//   - добавлено чтение и запись строки, состоящей из пробельных символов
